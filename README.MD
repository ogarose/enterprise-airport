...
## Вопросы
- Состояние самолета - запущен ли он или нет? Вместо проверки AircraftIsInExploitation.
- В агрегатах храним только id-ки других агрегатов? 
- Билет должны быть свободны - это как. У билета создать какой-то статус которые изменяется когда заказ создан 
  или какое-то правило должно это проверять?
- Passenger entity или value object?
